...
document.addEventListener('DOMContentLoaded', function () {
    const initialPageUrl = 'https://api.themoviedb.org/3/discover/movie?api_key=d9b0a83c9e832fe99a823757383466b9';
...
function handleSearch() {
    ...
    if (searchValue !== '') {
        var searchUrl = `https://api.themoviedb.org/3/search/movie?api_key=d9b0a83c9e832fe99a823757383466b9&query=${searchValue}`;
